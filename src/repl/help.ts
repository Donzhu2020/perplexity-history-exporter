...
export function showHelp(): void {
  ...
  logger.info(
    '  • RAG: Ask your exported history with the configured generation provider. Semantic retrieval uses the embedding provider and requires a built vector index.'
  )
  logger.info(
